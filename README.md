...
**Anomalies** and **outliers** are essentially the same thing: objects that are different from most other objects [2].
...
* **Intentional anomalies** are deviations caused by real-world events or actions, providing valuable insights into unique trends or occurrences. [3]
...
After calculating the z-score, we often refer to a z-score table to determine the probability or percentage of values that fall below or above a specific z-score. You can find a z-score table here: https://z-table.com/.
<br>
